...
export const zhLanguagePack: LanguagePack = {
  ...
  home: {
    ...
    postShipping: '邮政EMS',
    postShippingPrice: '海运首重86元+续重14元/kg\n空运首重(0.5kg)160元+续重14元/0.5kg',
  ...
  guide: {
    ...
    step4Desc4: '🚚 付款成功，仓库开工，等着拆箱超激动 skr！',
    ...
    step5Desc4: '🚚 付款成功，仓库开工，等着拆箱超激动 skr！',
    notesTitle: '注意事项',
    note1Title: '💰 价格填写',
...
export const koLanguagePack: LanguagePack = {
  ...
  home: {
    ...
    postShipping: '우체국EMS',
    postShippingPrice: '해운 기본요금 86위안+추가14위안/kg\n공항 기본요금(0.5kg) 160위안+추가14위안/0.5kg',
  ...
  guide: {
    ...
    step4Desc4: '🚚 결제하면 발송 완료! 당신의 택배 이제 출발!',
